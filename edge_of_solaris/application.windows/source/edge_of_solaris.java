/* autogenerated by Processing revision 1278 on 2022-03-23 */
 ...
 public void shoot() {
   if (enemyState != 2 && enemyX < 1250) {
    ...
    if (enemyTiming > 120) { //check to make sure enough time has passed since last shot
      ...
      blts[findBullet()] = new bullet(enemyX, enemyY, -2.828f, +2.828f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      blts[findBullet()] = new bullet(enemyX, enemyY, -2.828f, -2.828f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      blts[findBullet()] = new bullet(enemyX, enemyY, +2.828f, +2.828f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      blts[findBullet()] = new bullet(enemyX, enemyY, +2.828f, -2.828f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      
      blts[findBullet()] = new bullet(enemyX, enemyY, +1.53f, +3.695f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      blts[findBullet()] = new bullet(enemyX, enemyY, -1.53f, +3.695f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      blts[findBullet()] = new bullet(enemyX, enemyY, +1.53f, -3.695f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      blts[findBullet()] = new bullet(enemyX, enemyY, -1.53f, -3.695f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      
      blts[findBullet()] = new bullet(enemyX, enemyY, +3.695f, +1.53f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      blts[findBullet()] = new bullet(enemyX, enemyY, -3.695f, +1.53f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      blts[findBullet()] = new bullet(enemyX, enemyY, +3.695f, -1.53f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
      blts[findBullet()] = new bullet(enemyX, enemyY, -3.695f, -1.53f, 200, 10, 10, 10 * enemyBalanceDMG, 0);
