...
ControllerManager controllers = new ControllerManager();
 ...
 public void drawUI() {
  if (screenIndex == 0) { //in game
    ...
    stroke(0);
    fill(200, 255, 20);
    String playerMoneyShort = nf(PApplet.parseInt(playerMoney), 0, 0);
    text("$: " + PApplet.parseInt(playerMoneyShort), 550 * screenScaling, 680 * screenScaling);
    
    //render player level and xp bar
    fill(20, 255, 255);
    text("lv: " + playerLevel, 750 * screenScaling, 680 * screenScaling);
    rect(838 * screenScaling, 653.5f * screenScaling, (194 * (playerXP / pow(playerLevel +1, 3))) * screenScaling, 44 * screenScaling);
    noFill();
  ...
  damage(float damageXtemp, float damageYtemp, float damagetemp, int damageTypetemp, int damageTimertemp) {
   ...
   public void display() {
    if (damageTimer != 0) { //when timer runs out damage is dead
      String damageShort = nf(PApplet.parseInt(damage), 0, 0);
...
float RTDeadzone = 0.05f; //deadzone of right trigger
...
int[][] menuLimits = {
 ...
 public void skipVNText() { //when user wants to skip text, always on for always skip text mode
